...
export const metadata: Metadata = {
  metadataBase:        new URL(process.env.NEXT_PUBLIC_APP_URL || "https://jelboostgh.com"),
  title: {
    default:  "Jelboost GH — Grow Your Social Media Instantly",
    template: "%s | Jelboost GH",
  },
  ...
  authors:             [{ name: "Jelboost GH" }],
  creator:             "Jelboost GH",
  openGraph: {
    type:        "website",
    locale:      "en_US",
    url:         "https://jelboostgh.com",
    title:       "Jelboost GH — Grow Your Social Media Instantly",
